(function(f){if(typeof exports==="object"&&typeof module!=="undefined"){module.exports=f()}else if(typeof define==="function"&&define.amd){define([],f)}else{var g;if(typeof window!=="undefined"){g=window}else if(typeof global!=="undefined"){g=global}else if(typeof self!=="undefined"){g=self}else{g=this}g.newtondevMrzParser = f()}})(function(){var define,module,exports;return (function e(t,n,r){function s(o,u){if(!n[o]){if(!t[o]){var a=typeof require=="function"&&require;if(!u&&a)return a(o,!0);if(i)return i(o,!0);var f=new Error("Cannot find module '"+o+"'");throw f.code="MODULE_NOT_FOUND",f}var l=n[o]={exports:{}};t[o][0].call(l.exports,function(e){var n=t[o][1][e];return s(n?n:e)},l,l.exports,e,t,n,r)}return n[o].exports}var i=typeof require=="function"&&require;for(var o=0;o<r.length;o++)s(r[o]);return s})({1:[function(require,module,exports){
"use strict";
...
function parse (mrz) {
  ...
  let documentCode = _stripPadding(mrz.substring(0, 1));
  if (documentCode != 'P') {
    throw new Error('Not a passport MRZ, only passport MRZ currently supported!');
  }

  let documentType = _stripPadding(mrz.substring(1, 2));
  if (documentType == '') {
    documentType = null;
  }

  try {
    let issuerOrg = _stripPadding(mrz.substring(2, 5));
    let names = _getNames(mrz.substring(5, 44));
    let documentNumberRaw = mrz.substring(44, 53);
    let documentNumber = _stripPadding(documentNumberRaw);
    let checkDigit1 = mrz.substring(53, 54);
    let checkDigitVerify1 = _checkDigitVerify(documentNumberRaw, checkDigit1);
    let nationality = _getNationality(_stripPadding(mrz.substring(54, 57)));
    let dobRaw = mrz.substring(57, 63);
    let dob = _getFullDate(_stripPadding(dobRaw));
    let checkDigit2 = mrz.substring(63, 64);
    let checkDigitVerify2 = _checkDigitVerify(dobRaw, checkDigit2);
    let sex = _getSex(_stripPadding(mrz.substring(64, 65)));
    let expiryRaw = mrz.substring(65, 71);
    let expiry = _getFullDate(_stripPadding(expiryRaw));
    let checkDigit3 = _stripPadding(mrz.substring(71, 72));
    let checkDigitVerify3 = _checkDigitVerify(expiryRaw, checkDigit3);
    let personalNumberRaw = mrz.substring(72, 86);
    let personalNumber = _stripPadding(personalNumberRaw);
 ...
 * @private
 */
const _checkDigitVerify = (str, digit) => {
  let nmbrs = [];
  let weighting = [7, 3, 1];
